...
int main()
{
    ...
    for(i = 1; i <= T; i++) {
        if(infp[info[i].px].sw == true && infp[info[i].py].sw == true) {
            ...
            else if(infp[info[i].px].inf == true && infp[info[i].py].inf == true) {
                infp[info[i].px].cnt += 1;
                infp[info[i].py].cnt += 1;
            }
            else {
        ...
        else if(infp[info[i].px].sw == false && infp[info[i].py].sw == true) {
            infp[info[i].py].cnt += 1;
        }

        else if(infp[info[i].px].sw == true && infp[info[i].py].sw == false) {
            infp[info[i].px].cnt += 1;
        }
